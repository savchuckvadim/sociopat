...
const NavMenu = (props) => {
    ...
    let iconProfile =
        <svg key={`profile-${props.profileIconClass}`} className={props.profileIconClass} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    let iconMessages =
        <svg key={`messages-${props.messagesIconClass}`} className={props.messagesIconClass} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    let iconPeople =
        <svg key={`users-${props.usersIconClass}`} className={props.usersIconClass} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
